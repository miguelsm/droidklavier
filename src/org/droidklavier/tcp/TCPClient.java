...
public class TCPClient {
	...
	private synchronized void setState(int state) {
		...
		mHandler.obtainMessage(TCPHandler.MESSAGE_STATE_CHANGE, state, -1)
				.sendToTarget();
	}
	...
	public synchronized void connected() {
		...
		Message msg = mHandler
				.obtainMessage(TCPHandler.MESSAGE_CONNECTED_ADDRESS);
	...
	private void connectionLost() {
		...
		stop();
		mHandler.obtainMessage(TCPHandler.MESSAGE_CONNECTION_LOST)
				.sendToTarget();
	}
	...
	private void connectionFailed() {
		...
		stop();
		mHandler.obtainMessage(TCPHandler.MESSAGE_CONNECTION_FAILED)
				.sendToTarget();
	}
	...
	private class ConnectedThread extends Thread {
		...
		public void write(String message) {
			...
			if (mWriter != null && !mWriter.checkError()) {
				...
				mHandler.obtainMessage(TCPHandler.MESSAGE_WRITE, -1, -1,
