...
public class Crypto {
  ...
  public static String encrypt(String str, String password) {
    ...
    byte[] encryptedData = new byte[cipher.getOutputSize(enc_msg.getBytes().length)];
    int noOfBytes = cipher.processBytes(enc_msg.getBytes(), 0, enc_msg.getBytes().length, encryptedData, 0);
