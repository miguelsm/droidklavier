...
public class RC {
  ...
  public static String rcStatus() {
    return String.format("<rc_status rc=\"%1$s\" version=\"%2$d\" />", TRC, VERSION);
  }
  ...
  public static String loadSongSource(String source, int album_id, int displayOrder) {
    return String.format(
        "<load_song source_id=\"%1$s\" album_id=\"%2$d\" sel_song_no=\"%3$d\" />",
        source,
        album_id,
        displayOrder);
  }
